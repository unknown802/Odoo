        ...
        {actions.map((action) => {
          ...
          return (
            <motion.button
              ...
              className={`group relative flex w-full items-center justify-between rounded-xl border border-slate-200 bg-white p-3 text-left transition-all hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 ${action.borderColor}`}
            >
              <div className="flex items-center gap-4">
                <div className={`grid h-10 w-10 place-items-center rounded-lg ${action.bg}`}>
              ...
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-50 text-slate-400 opacity-0 transition-all group-hover:bg-slate-100 group-hover:text-slate-700 group-hover:opacity-100 group-hover:translate-x-1">
